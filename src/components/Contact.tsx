      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-tech-blue/20 to-tech-purple/20 border border-tech-blue/30 mb-6">
            <span className="text-sm font-medium text-tech-blue">Get In Touch</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Let's Start Your 
            <span className="bg-gradient-to-r from-tech-blue to-tech-purple bg-clip-text text-transparent"> Project</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map((info, index) => (
                <Card 
                  key={index} 
                  className="group hover:scale-105 transition-all duration-300 bg-gradient-to-br from-card to-secondary/10 border-border/50 hover:border-tech-blue/50 cursor-pointer"
                  onClick={() => info.link !== "#" && window.open(info.link, '_blank')}
                >
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      <div className="p-3 bg-gradient-to-r from-tech-blue to-tech-purple rounded-lg text-primary-foreground">
                        {info.icon}
                      </div>
                      <div>
                        <h4 className="font-semibold text-lg group-hover:text-tech-blue transition-colors">
                          {info.title}
                        </h4>
            ...
            {/* Business Hours */}
            <Card className="bg-gradient-to-r from-tech-blue/10 to-tech-purple/10 border border-tech-blue/20">
              <CardContent className="p-6">
          ...
          <div className="animate-slide-up">
            ...
            <div className="space-y-4 mb-8">
              <h4 className="font-semibold text-lg mb-4">Enquire About Our Services:</h4>
              {services.map((service, index) => (
                <Button
                  key={index}
                  variant="outline"
                  className="w-full justify-start border-tech-blue/30 text-tech-blue hover:bg-tech-blue/10 transition-colors"
            ...
            <Card className="bg-gradient-to-r from-tech-blue/10 to-tech-purple/10 border border-tech-blue/20">
              <CardContent className="p-8 text-center">
                <div className="mb-6">
                  <div className="inline-flex p-4 bg-gradient-to-r from-tech-blue to-tech-purple rounded-full text-primary-foreground mb-4">
                    <MessageCircle className="h-8 w-8" />
                  </div>
                  <h4 className="text-xl font-bold mb-2">Chat with Us Now</h4>
            ...
            {/* Additional Info */}
            <div className="mt-8 p-6 rounded-lg bg-gradient-to-r from-tech-cyan/10 to-tech-orange/10 border border-tech-cyan/20">
              <div className="flex items-center space-x-4 mb-4">
                <Globe className="h-6 w-6 text-tech-cyan" />
                <h4 className="font-semibold">Serving Across UAE</h4>
              </div>
              <p className="text-muted-foreground">
